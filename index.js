...
const cholateMilk =createMenuItem("Chocolate Milk", 3, "Drinks")
const pizza =createMenuItem("Pizza", 5, "Lunch")
const greenTea =createMenuItem("Green Tea", 2, "Drinks")
...
burger.discoutn = function (string) {
...
createReview(reviews, "Monokioko", 5, "Best. Chocolate Milk. EVER!! That along with their Hawai'in Pizza just made my entire day.")
